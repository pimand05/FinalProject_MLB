...
public class ControllerPosiciones implements Initializable {
    ...
    /*
    public void rotarPanelConHijos(Pane panel) {
        // Rotar el panel principal
        RotateTransition rotacionPanel = new RotateTransition(Duration.seconds(0.8), panel);
        rotacionPanel.setAxis(Rotate.X_AXIS);
        rotacionPanel.setByAngle(360);
        rotacionPanel.setCycleCount(1);
        rotacionPanel.setAutoReverse(false);
        rotacionPanel.play();

        // Rotar todos los hijos del panel
        for (Node hijo : panel.getChildren()) {
            RotateTransition rotacionHijo = new RotateTransition(Duration.seconds(0.8), hijo);
            rotacionPanel.setAxis(Rotate.X_AXIS);
            rotacionHijo.setByAngle(360);
            rotacionHijo.setCycleCount(1);
            rotacionHijo.setAutoReverse(false);
            rotacionHijo.play();
        }
    }
     */
    ...
    public void fadeIn(Pane panel) {
        // Inicialmente hacemos que el panel sea invisible
    ...
    private void addJugadoresAutomaticamente(String a, Jugador jugador) {
        ...
        switch (a) {
            case "1B":
                ...
                Image1B.setImage(getImageRoute(bateador,null));
                break;
            case "2B":
    ...
    @FXML
    private ImageView ImageCF;

    @FXML
    private ImageView ImageLF;
    ...
    @FXML
    private Label lblAVG1B;

    @FXML
    private Label lblAVG2B;

    @FXML
    private Label lblAVG3B;

    @FXML
    private Label lblAVGC;

    @FXML
    private Label lblAVGCF;

    @FXML
    private Label lblAVGLF;

    @FXML
    private Label lblAVGP;

    @FXML
    private Label lblAVGRF;

    @FXML
    private Label lblAVGSS;

    @FXML
    private Label lblHR1B;

    @FXML
    private Label lblHR2B;

    @FXML
    private Label lblHR3B;

    @FXML
    private Label lblHRC;

    @FXML
    private Label lblHRCF;

    @FXML
    private Label lblHRLF;

    @FXML
    private Label lblHRP;

    @FXML
    private Label lblHRRF;

    @FXML
    private Label lblHRSS;

    @FXML
    private Label lblHit1B;

    @FXML
    private Label lblHit2B;

    @FXML
    private Label lblHit3B;

    @FXML
    private Label lblHitC;

    @FXML
    private Label lblHitCF;

    @FXML
    private Label lblHitLF;

    @FXML
    private Label lblHitP;

    @FXML
    private Label lblHitRF;

    @FXML
    private Label lblHitSS;

    @FXML
    private Label lblNombre1B;

    @FXML
    private Label lblNombre2B;

    @FXML
    private Label lblNombre3B;

    @FXML
    private Label lblNombreC;

    @FXML
    private Label lblNombreCF;

    @FXML
    private Label lblNombreLF;

    @FXML
    private Label lblNombreP;

    @FXML
    private Label lblNombreRF;

    @FXML
    private Label lblNombreSS;

    @FXML
    private Label lblNumero1B;

    @FXML
    private Label lblNumero2B;

    @FXML
    private Label lblNumero3B;

    @FXML
    private Label lblNumeroC;

    @FXML
    private Label lblNumeroCF;

    @FXML
    private Label lblNumeroLF;

    @FXML
    private Label lblNumeroP;

    @FXML
    private Label lblNumeroRF;

    @FXML
    private Label lblNumeroSS;

    @FXML
    private Pane panel1B;

    @FXML
    private Pane panel2B;

    @FXML
    private Pane panel3B;

    @FXML
    private Pane panelC;

    @FXML
    private Pane panelCF;

    @FXML
    private Pane panelLF;

    @FXML
    private Pane panelP;

    @FXML
    private Pane panelRF;

    @FXML
    private Pane panelSS;
