...
public class AppMain extends Application {
    ...
    public void start(Stage primaryStage) {
        app = this;
        loadStage(primaryStage, Paths.MAIN,"SERIE MUNDIAL");  // Carga la primera vista en la ventana principal.
    }

    // Método reutilizable para cargar y mostrar una vista en el Stage que se le pase.
    private void loadStage(Stage stage, String fxmlPath, String title) {
        try {
